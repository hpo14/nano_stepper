...
#define PROVIDE_SECOND_ARGUMENT(x, ...)                                 \
    CONCAT(IFMULTIARG(ID(__VA_ARGS__), INSERT_, ADD_), SECOND_ARGUMENT) \
    (x, __VA_ARGS__)
#define PROVIDE_SECOND_ARGUMENT2(x, y, ...)                              \
    CONCAT(IFMULTIARG(ID(__VA_ARGS__), INSERT_, ADD_), SECOND_ARGUMENT2) \
    (x, y, __VA_ARGS__)
